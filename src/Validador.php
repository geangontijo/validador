...
abstract class Validador
{
    ...
    private function validacaoData($value): bool
    {
    ...
    private function validacaoNumero($value): bool
    {
        if (!is_numeric($value)) {
            return false;
        }
    ...
    private function validacaoTelefone($value): bool
    {
    ...
    private function validacaoString($value): bool
    {
    ...
    private function validacaoSanizar($value): bool
    {
        if (
            stripos($value, '#') !== false ||
            stripos($value, '@') !== false ||
    ...
    private function validacaoEmail($value): bool
    {
    ...
    private function validacaoObrigatoria($value): bool
    {
